...
//        this.leetCode75.deleteMiddle(nodeHead);
    ...
    public void longestCommonSubsequenceTest() {
        Assert.assertEquals(3, this.leetCode75.longestCommonSubsequence("abcde", "abc"));
        Assert.assertEquals(3, this.leetCode75.longestCommonSubsequence("abcabc", "abc"));
        Assert.assertEquals(0, this.leetCode75.longestCommonSubsequence("def", "abc"));
        Assert.assertEquals(1, this.leetCode75.longestCommonSubsequence("psnw", "vozsh"));
        Assert.assertEquals(4, this.leetCode75.longestCommonSubsequence("mississippi", "issi"));
        Assert.assertEquals(3, this.leetCode75.longestCommonSubsequence("massubtera", "submarine"));
    }
...
//        Assert.assertEquals(6, this.leetCode75.minCostClimbingStairs(new int[] {1,100,1,1,1,100,1,1,100,1}));
    ...
    public void successfulPairsTest() {
        Assert.assertArrayEquals(new int[]{4,0,3}, this.leetCode75.successfulPairs(new int[]{5,1,3}, new int[]{1,2,3,4,5}, 7));
        Assert.assertArrayEquals(new int[]{2,0,2}, this.leetCode75.successfulPairs(new int[]{3,1,2}, new int[]{8,5,8}, 16));
    }

    @Test
    public void findPeakElementTest() {
        Assert.assertEquals(2, this.leetCode75.findPeakElement(new int[]{1,2,3,1}));
        Assert.assertEquals(5, this.leetCode75.findPeakElement(new int[]{1,2,1,3,5,6,4}));
        Assert.assertEquals(2, this.leetCode75.findPeakElement(new int[]{1,2,3}));
        Assert.assertEquals(1, this.leetCode75.findPeakElement(new int[]{1,2}));
        Assert.assertEquals(0, this.leetCode75.findPeakElement(new int[]{2,1}));
        Assert.assertEquals(1, this.leetCode75.findPeakElement(new int[]{1,3,2,1}));
        Assert.assertEquals(2, this.leetCode75.findPeakElement(new int[]{2,3,4,3,2,1}));
    }

    @Test
    public void minEatingSpeedTest() {
        Assert.assertEquals(3, this.leetCode75.minEatingSpeed(new int[]{805306368,805306368,805306368}, 1000000000));
        Assert.assertEquals(4, this.leetCode75.minEatingSpeed(new int[]{3,6,7,11}, 8));
        Assert.assertEquals(30, this.leetCode75.minEatingSpeed(new int[]{30,11,23,4,20}, 5));
        Assert.assertEquals(23, this.leetCode75.minEatingSpeed(new int[]{30,11,23,4,20}, 6));
    }
    ...
    public void eraseOverlapIntervalsTest() {
        Assert.assertEquals(1, this.leetCode75.eraseOverlapIntervals(
                new int[][]{{1,2},
                {2,3},
                {3,4},
                {1,3}})); // enveloping

        Assert.assertEquals(2, this.leetCode75.eraseOverlapIntervals(
                new int[][]{{1,2},
                        {1,2},
                        {1,2}})); // same

        Assert.assertEquals(0, this.leetCode75.eraseOverlapIntervals(
                new int[][]{{1,2},
                        {2,3}})); // touching
    ...
    @Test
    public void findMinArrowShotsTest() { // TODO
        Assert.assertEquals(3, this.leetCode75.findMinArrowShots(new int[][]{
                {1,2},
                {2,3},
                {8,10},
                {6,7}}));

        Assert.assertEquals(2, this.leetCode75.findMinArrowShots(new int[][]{
                {10,16},
                {2,8},
                {1,6},
                {7,12}}));

        Assert.assertEquals(4, this.leetCode75.findMinArrowShots(new int[][]{
                {1,2},
                {3,4},
                {5,6},
                {7,8}}));
    ...
    public void countBitsTest() {
        Assert.assertEquals(new int[] {}, this.leetCode75.countBits(4));
    }
